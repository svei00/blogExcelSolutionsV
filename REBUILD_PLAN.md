...
| Task | Hint |
|------|------|
| **2.1 Spike (½ day, throwaway branch)** | Minimal page with Toast UI React wrapper: paste a real Markdown draft, insert an image, toggle dark mode. Confirms no blocker before you commit to the path. |
