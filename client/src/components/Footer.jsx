        ...
        <div className="w-full sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex gap-6 sm:mt-0 mt-4 sm:justify-center">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover-instagram-gradient transition duration-300 ease-in-out"
            >
              <FaInstagram />
            </a>
            <a
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-500 hover-tiktok-gradient transition duration-300 ease-in-out"
            >
              <FaTiktok />
            </a>
            <a
